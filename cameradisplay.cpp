...
// stop camera
void CameraDisplay::closeCamera(){
...
void CameraDisplay::initializeCameraParams(){
...
void CameraDisplay::setCameraParams(int param, int value){
...
void CameraDisplay::eventSignaled(HANDLE h) {
...
void CameraDisplay::optimizeCameraParams(){
...
void CameraDisplay::checkFrameRate(){
...
void CameraDisplay::changeCameraROI(QRectF boundingROI)
{
...
// start recording avi
void CameraDisplay::startRecording()
{
...
// stop recording avi
void CameraDisplay::stopRecording()
{
